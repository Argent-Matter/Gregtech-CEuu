package net.nemezanevem.gregtech.client.renderer.texture;
...
public class Textures {
    ...
    public static final ResourceLocation GREGTECH_CAPE_TEXTURE = new ResourceLocation(GregTech.MODID, "textures/capes/gregtechcape.png");
    public static final ResourceLocation RED_CAPE_TEXTURE = new ResourceLocation(GregTech.MODID, "textures/capes/redcape.png");
    public static final ResourceLocation YELLOW_CAPE_TEXTURE = new ResourceLocation(GregTech.MODID, "textures/capes/yellowcape.png");
    public static final ResourceLocation GREEN_CAPE_TEXTURE = new ResourceLocation(GregTech.MODID, "textures/capes/greencape.png");
