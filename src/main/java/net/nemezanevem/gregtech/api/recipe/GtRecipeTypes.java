...
public class GtRecipeTypes {
    ...
    public class RecipeMaps {
         ...
         */
        @ZenProperty
        public static final RegistryObject<GTRecipeType<GTRecipe>> ALLOY_SMELTER_RECIPES = new GTRecipeTypeImpl<>("alloy_smelter", 1, 2, 1, 1, 0, 0, 0, 0, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> ARC_FURNACE_RECIPES = new RecipeMap<>("arc_furnace", 1, 1, 1, 4, 1, 1, 0, 1, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<IntCircuitRecipeBuilder>> ASSEMBLER_RECIPES = new RecipeMap<>("assembler", 1, 9, 1, 1, 0, 1, 0, 0, new AssemblerRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> AUTOCLAVE_RECIPES = new RecipeMap<>("autoclave", 1, 2, 1, 2, 1, 1, 0, 1, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<IntCircuitRecipeBuilder>> BENDER_RECIPES = new RecipeMap<>("bender", 2, 2, 1, 1, 0, 0, 0, 0, new IntCircuitRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<BlastRecipeBuilder>> BLAST_RECIPES = new RecipeMap<>("electric_blast_furnace", 1, 3, 0, 3, 0, 1, 0, 1, new BlastRecipeBuilder(), false)
                .setSound(GTSoundEvents.FURNACE);
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> BREWING_RECIPES = new RecipeMap<>("brewery", 1, 1, 0, 0, 1, 1, 1, 1, new SimpleRecipeBuilder().duration(128).EUt(4), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> CANNER_RECIPES = new RecipeMapFluidCanner("canner", 1, 2, 1, 2, 0, 1, 0, 1, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> CENTRIFUGE_RECIPES = new RecipeMap<>("centrifuge", 0, 2, 0, 6, 0, 1, 0, 6, new SimpleRecipeBuilder().EUt(5), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> CHEMICAL_BATH_RECIPES = new RecipeMap<>("chemical_bath", 1, 1, 1, 6, 1, 1, 0, 1, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<CircuitAssemblerRecipeBuilder>> CIRCUIT_ASSEMBLER_RECIPES = new RecipeMap<>("circuit_assembler",
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<PrimitiveRecipeBuilder>> COKE_OVEN_RECIPES = new RecipeMapCokeOven<>("coke_oven", 1, 1, 0, 1, 0, 0, 0, 1, new PrimitiveRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> COMPRESSOR_RECIPES = new RecipeMap<>("compressor", 1, 1, 1, 1, 0, 0, 0, 0, new SimpleRecipeBuilder().duration(200).EUt(2), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> CRACKING_RECIPES = new RecipeMapCrackerUnit<>("cracker", 0, 1, 0, 0, 2, 2, 0, 2, new SimpleRecipeBuilder(), false)
        ...
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> CUTTER_RECIPES = new RecipeMap<>("cutter", 1, 1, 1, 2, 0, 1, 0, 0, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<UniversalDistillationRecipeBuilder>> DISTILLATION_RECIPES = new RecipeMapDistillationTower("distillation_tower", 0, 0, 0, 1, 1, 1, 1, 12, new UniversalDistillationRecipeBuilder(), false)
                .setSound(GTSoundEvents.CHEMICAL_REACTOR);
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<IntCircuitRecipeBuilder>> DISTILLERY_RECIPES = new RecipeMap<>("distillery", 1, 1, 0, 1, 1, 1, 1, 1, new IntCircuitRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> ELECTROLYZER_RECIPES = new RecipeMap<>("electrolyzer", 0, 2, 0, 6, 0, 1, 0, 6, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> ELECTROMAGNETIC_SEPARATOR_RECIPES = new RecipeMap<>("electromagnetic_separator", 1, 1, 1, 3, 0, 0, 0, 0, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> EXTRACTOR_RECIPES = new RecipeMap<>("extractor", 0, 1, 0, 1, 0, 0, 0, 1, new SimpleRecipeBuilder().duration(400).EUt(2), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> EXTRUDER_RECIPES = new RecipeMap<>("extruder", 2, 2, 1, 1, 0, 0, 0, 0, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> FERMENTING_RECIPES = new RecipeMap<>("fermenter", 0, 1, 0, 1, 1, 1, 1, 1, new SimpleRecipeBuilder().EUt(2), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<IntCircuitRecipeBuilder>> FLUID_HEATER_RECIPES = new RecipeMap<>("fluid_heater", 1, 1, 0, 0, 1, 1, 1, 1, new IntCircuitRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> FLUID_SOLIDFICATION_RECIPES = new RecipeMap<>("fluid_solidifier", 1, 1, 1, 1, 1, 1, 0, 0, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> FORGE_HAMMER_RECIPES = new RecipeMap<>("forge_hammer", 1, 1, 1, 1, 0, 0, 0, 0, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> FORMING_PRESS_RECIPES = new RecipeMapFormingPress("forming_press", 2, 6, 1, 1, 0, 0, 0, 0, new SimpleRecipeBuilder(), false)
                .setProgressBar(GuiTextures.PROGRESS_BAR_COMPRESS, MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.COMPRESSOR);
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> FURNACE_RECIPES = new RecipeMapFurnace("electric_furnace", 1, 1, 1, 1, 0, 0, 0, 0, new SimpleRecipeBuilder(), false)
                .setSlotOverlay(false, false, GuiTextures.FURNACE_OVERLAY_1)
                .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW, MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.FURNACE);
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<FusionRecipeBuilder>> FUSION_RECIPES = new RecipeMap<>("fusion_reactor", 0, 0, 0, 0, 2, 2, 0, 1, new FusionRecipeBuilder(), false)
                .setProgressBar(GuiTextures.PROGRESS_BAR_FUSION, MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.ARC);

        @ZenProperty
        public static final RegistryObject<RecipeMap<GasCollectorRecipeBuilder>> GAS_COLLECTOR_RECIPES = new RecipeMap<>("gas_collector", 1, 1, 0, 0, 0, 0, 1, 1, new GasCollectorRecipeBuilder(), false)
                .setSlotOverlay(false, false, GuiTextures.INT_CIRCUIT_OVERLAY)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<ImplosionRecipeBuilder>> IMPLOSION_RECIPES = new RecipeMap<>("implosion_compressor", 2, 3, 0, 2, 0, 0, 0, 0, new ImplosionRecipeBuilder().duration(20).EUt(VA[LV]), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> LARGE_CHEMICAL_RECIPES = new RecipeMap<>("large_chemical_reactor", 0, 3, 0, 3, 0, 5, 0, 4, new SimpleRecipeBuilder().EUt(VA[LV]), false)
                .setSlotOverlay(false, false, false, GuiTextures.MOLECULAR_OVERLAY_1)
                .setSlotOverlay(false, false, true, GuiTextures.MOLECULAR_OVERLAY_2)
                .setSlotOverlay(false, true, false, GuiTextures.MOLECULAR_OVERLAY_3)
                .setSlotOverlay(false, true, true, GuiTextures.MOLECULAR_OVERLAY_4)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> LASER_ENGRAVER_RECIPES = new RecipeMap<>("laser_engraver", 2, 2, 1, 1, 0, 0, 0, 0, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> LATHE_RECIPES = new RecipeMap<>("lathe", 1, 1, 1, 2, 0, 0, 0, 0, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> MACERATOR_RECIPES = new RecipeMap<>("macerator", 1, 1, 1, 4, 0, 0, 0, 0, new SimpleRecipeBuilder().duration(150).EUt(2), false)
                .setSlotOverlay(false, false, GuiTextures.CRUSHED_ORE_OVERLAY)
                .setSlotOverlay(true, false, GuiTextures.DUST_OVERLAY)
        ...
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> MASS_FABRICATOR_RECIPES = new RecipeMap<>("mass_fabricator", 0, 1, 0, 0, 0, 1, 1, 2, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> MIXER_RECIPES = new RecipeMap<>("mixer", 0, 6, 0, 1, 0, 2, 0, 1, new SimpleRecipeBuilder(), false)
                .setSlotOverlay(false, false, GuiTextures.DUST_OVERLAY)
                .setSlotOverlay(true, false, GuiTextures.DUST_OVERLAY)
                .setProgressBar(GuiTextures.PROGRESS_BAR_MIXER, MoveType.CIRCULAR)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> ORE_WASHER_RECIPES = new RecipeMap<>("ore_washer", 1, 2, 1, 3, 0, 1, 0, 0, new SimpleRecipeBuilder().duration(400).EUt(16), false)
                .setSlotOverlay(false, false, GuiTextures.CRUSHED_ORE_OVERLAY)
                .setSlotOverlay(true, false, GuiTextures.DUST_OVERLAY)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> PACKER_RECIPES = new RecipeMap<>("packer", 1, 2, 1, 2, 0, 0, 0, 0, new SimpleRecipeBuilder().EUt(12).duration(10), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> POLARIZER_RECIPES = new RecipeMap<>("polarizer", 1, 1, 1, 1, 0, 0, 0, 0, new SimpleRecipeBuilder(), false)
                .setProgressBar(GuiTextures.PROGRESS_BAR_MAGNET, MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.ARC);
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<PrimitiveRecipeBuilder>> PRIMITIVE_BLAST_FURNACE_RECIPES = new RecipeMap<>("primitive_blast_furnace", 2, 3, 0, 3, 0, 0, 0, 0, new PrimitiveRecipeBuilder(), false)
                .setSound(GTSoundEvents.FIRE);
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<IntCircuitRecipeBuilder>> PYROLYSE_RECIPES = new RecipeMap<>("pyrolyse_oven", 2, 2, 0, 1, 0, 1, 0, 1, new IntCircuitRecipeBuilder(), false)
                .setSound(GTSoundEvents.FIRE);
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> REPLICATOR_RECIPES = new RecipeMap<>("replicator", 1, 1, 0, 1, 1, 2, 0, 1, new SimpleRecipeBuilder(), false)
        ...
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> ROCK_BREAKER_RECIPES = new RecipeMap<>("rock_breaker", 1, 1, 1, 4, 0, 0, 0, 0, new SimpleRecipeBuilder(), false)
                .setSlotOverlay(false, false, GuiTextures.DUST_OVERLAY)
        ...
        @ZenProperty
        @SuppressWarnings("unused")
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> SCANNER_RECIPES = new RecipeMap<>("scanner", 0, 2, 1, 1, 0, 1, 0, 0, new SimpleRecipeBuilder(), false)
                .setSlotOverlay(false, false, GuiTextures.DATA_ORB_OVERLAY)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> SIFTER_RECIPES = new RecipeMap<>("sifter", 1, 1, 0, 6, 0, 0, 0, 0, new SimpleRecipeBuilder(), false)
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> THERMAL_CENTRIFUGE_RECIPES = new RecipeMap<>("thermal_centrifuge", 1, 1, 1, 3, 0, 0, 0, 0, new SimpleRecipeBuilder().duration(400).EUt(30), false)
                .setSlotOverlay(false, false, GuiTextures.CRUSHED_ORE_OVERLAY)
                .setSlotOverlay(true, false, GuiTextures.DUST_OVERLAY)
                .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW, MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.CENTRIFUGE);
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> VACUUM_RECIPES = new RecipeMap<>("vacuum_freezer", 0, 1, 0, 1, 0, 2, 0, 1, new SimpleRecipeBuilder().EUt(VA[MV]), false)
                .setSound(GTSoundEvents.COOLING);
         ...
         */
        @ZenProperty
        public static final RegistryObject<RecipeMap<SimpleRecipeBuilder>> WIREMILL_RECIPES = new RecipeMap<>("wiremill", 1, 1, 1, 1, 0, 0, 0, 0, new SimpleRecipeBuilder(), false)
        ...
        @ZenProperty
        public static final RegistryObject<RecipeMap<FuelRecipeBuilder>> COMBUSTION_GENERATOR_FUELS = new RecipeMap<>("combustion_generator", 0, 0, 0, 0, 1, 1, 0, 0, new FuelRecipeBuilder(), false)
                .setSlotOverlay(false, true, true, GuiTextures.FURNACE_OVERLAY_2)
                .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW_MULTIPLE, MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.COMBUSTION);

        @ZenProperty
        public static final RegistryObject<RecipeMap<FuelRecipeBuilder>> GAS_TURBINE_FUELS = new RecipeMap<>("gas_turbine", 0, 0, 0, 0, 1, 1, 0, 0, new FuelRecipeBuilder(), false)
                .setSlotOverlay(false, true, true, GuiTextures.DARK_CANISTER_OVERLAY)
                .setProgressBar(GuiTextures.PROGRESS_BAR_GAS_COLLECTOR, MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.TURBINE);

        @ZenProperty
        public static final RegistryObject<RecipeMap<FuelRecipeBuilder>> STEAM_TURBINE_FUELS = new RecipeMap<>("steam_turbine", 0, 0, 0, 0, 1, 1, 0, 1, new FuelRecipeBuilder(), false)
                .setSlotOverlay(false, true, true, GuiTextures.CENTRIFUGE_OVERLAY)
                .setProgressBar(GuiTextures.PROGRESS_BAR_GAS_COLLECTOR, MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.TURBINE);

        @ZenProperty
        public static final RegistryObject<RecipeMap<FuelRecipeBuilder>> SEMI_FLUID_GENERATOR_FUELS = new RecipeMap<>("semi_fluid_generator", 0, 0, 0, 0, 1, 1, 0, 0, new FuelRecipeBuilder(), false)
                .setSlotOverlay(false, true, true, GuiTextures.FURNACE_OVERLAY_2)
                .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW_MULTIPLE, MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.COMBUSTION);

        @ZenProperty
        public static final RegistryObject<RecipeMap<FuelRecipeBuilder>> PLASMA_GENERATOR_FUELS = new RecipeMap<>("plasma_generator", 0, 0, 0, 0, 1, 1, 0, 1, new FuelRecipeBuilder(), false)
                .setSlotOverlay(false, true, true, GuiTextures.CENTRIFUGE_OVERLAY)
                .setProgressBar(GuiTextures.PROGRESS_BAR_GAS_COLLECTOR, MoveType.HORIZONTAL)
                .setSound(GTSoundEvents.TURBINE);
    }
