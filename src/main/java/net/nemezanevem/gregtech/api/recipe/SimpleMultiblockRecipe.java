...
public class SimpleMultiblockRecipe {
    public class ShapelessRecipe implements CraftingRecipe {
        ...
        public static class Serializer implements RecipeSerializer<net.minecraft.world.item.crafting.ShapelessRecipe> {
            private static final ResourceLocation NAME = new ResourceLocation("minecraft", "crafting_shapeless");
            public net.minecraft.world.item.crafting.ShapelessRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
                ...
                if (nonnulllist.isEmpty()) {
                    ...
                    return new net.minecraft.world.item.crafting.ShapelessRecipe(pRecipeId, s, itemstack, nonnulllist);
                }
            }
            ...
            public net.minecraft.world.item.crafting.ShapelessRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
            ...
            public void toNetwork(FriendlyByteBuf pBuffer, net.minecraft.world.item.crafting.ShapelessRecipe pRecipe) {
