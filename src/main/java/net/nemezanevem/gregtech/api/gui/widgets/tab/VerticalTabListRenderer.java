...
public class VerticalTabListRenderer extends TabListRenderer {
    ...
    private static final class LeftTextures {
        ...
        private static final TextureArea startTabInactiveTexture = TABS_LEFT_TEXTURE.getSubArea(0, 0, 0.5f, 1.0f / 3.0f);
        private static final TextureArea startTabActiveTexture = TABS_LEFT_TEXTURE.getSubArea(0.5f, 0, 0.5f, 1.0f / 3.0f);

        private static final TextureArea middleTabInactiveTexture = TABS_LEFT_TEXTURE.getSubArea(0, 1.0f / 3, 0.5f, 1.0f / 3.0f);
        private static final TextureArea middleTabActiveTexture = TABS_LEFT_TEXTURE.getSubArea(0.5f, 1.0f / 3, 0.5f, 1.0f / 3.0f);

        private static final TextureArea endTabInactiveTexture = TABS_LEFT_TEXTURE.getSubArea(0, 2.0f / 3, 0.5f, 1.0f / 3.0f);
        private static final TextureArea endTabActiveTexture = TABS_LEFT_TEXTURE.getSubArea(0.5f, 2.0f / 3, 0.5f, 1.0f / 3.0f);
    ...
    private static final class RightTextures {
        ...
        private static final TextureArea startTabInactiveTexture = TABS_RIGHT_TEXTURE.getSubArea(0.5f, 0, 0.5f, 1.0f / 3.0f);
        private static final TextureArea startTabActiveTexture = TABS_RIGHT_TEXTURE.getSubArea(0, 0, 0.5f, 1.0f / 3.0f);

        private static final TextureArea middleTabInactiveTexture = TABS_RIGHT_TEXTURE.getSubArea(0.5f, 1.0f / 3, 0.5f, 1.0f / 3.0f);
        private static final TextureArea middleTabActiveTexture = TABS_RIGHT_TEXTURE.getSubArea(0, 1.0f / 3, 0.5f, 1.0f / 3.0f);

        private static final TextureArea endTabInactiveTexture = TABS_RIGHT_TEXTURE.getSubArea(0.5f, 2.0f / 3, 0.5f, 1.0f / 3.0f);
        private static final TextureArea endTabActiveTexture = TABS_RIGHT_TEXTURE.getSubArea(0, 2.0f / 3, 0.5f, 1.0f / 3.0f);
