...
public interface ISpecialArmorLogic extends IArmorLogic {
     ...
     * absorption ratio.
     */
    ArmorProperties getProperties(LivingEntity player, @Nonnull ItemStack armor, DamageSource source, double damage, EquipmentSlot equipmentSlot);
     ...
     */
    default boolean handleUnblockableDamage(LivingEntity entity, @Nonnull ItemStack armor, DamageSource source, double damage, EquipmentSlot equipmentSlot) {
        return false;
    }
}
