package net.nemezanevem.gregtech.api.item.toolitem.behavior;
...
public interface IToolBehavior {
    ...
    default void addInformation(@Nonnull ItemStack stack, @Nullable Level world, @Nonnull List<String> tooltip, @Nonnull TooltipFlag flag) {
    }
     ...
     */
    default ICapabilityProvider createProvider(ItemStack stack, @Nullable CompoundTag tag) {
        return null;
    }
}
