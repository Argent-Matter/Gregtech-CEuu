...
public class ConfigHolder {
    ...
    builder.comment("Config options for Tools and Armor")
    builder.push("Tool and Armor Options")
    @Config.RequiresMcRestart
   ...
   builder.("Worldgen Options")
    ...
    public static class ClientOptions {
        ...
        public static class GuiConfig {
            builder.comment({"The scrolling speed of widgets", "Default: 13"})
        ...
        public static class ArmorHud {
            ...
            builder.comment({"Sets HUD location", "1 - left-upper corner", "2 - right-upper corner", "3 - left-bottom corner", "4 - right-bottom corner", "Default: 1"})
