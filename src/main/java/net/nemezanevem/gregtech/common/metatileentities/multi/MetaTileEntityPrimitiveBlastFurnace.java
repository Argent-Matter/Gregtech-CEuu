...
public class MetaTileEntityPrimitiveBlastFurnace extends RecipeTypePrimitiveMultiblockController {

    private static final TraceabilityPredicate IS_SNOW_LAYER = new TraceabilityPredicate(bws -> Util.isBlockSnowLayer(bws.getBlockState()));

    public MetaTileEntityPrimitiveBlastFurnace(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, RecipeTypes.PRIMITIVE_BLAST_FURNACE_RECIPES);
    }
    ...
    protected ModularUI.Builder createUITemplate(Player entityPlayer) {
        return ModularUI.builder(GuiTextures.PRIMITIVE_BACKGROUND, 176, 166)
                ...
                .widget(new RecipeProgressWidget(recipeMapWorkable::getProgressPercent, 77, 39, 20, 15, GuiTextures.PRIMITIVE_BLAST_FURNACE_PROGRESS_BAR, ProgressWidget.MoveType.HORIZONTAL, RecipeTypes.PRIMITIVE_BLAST_FURNACE_RECIPES))
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        if (recipeMapWorkable.isActive() && isStructureFormed()) {
            ...
            Textures.renderFace(renderState, offset,
                    ...
                    Direction.UP, Cuboid6.full, TextureUtils.getBlockTexture("lava_still"), BloomEffectUtil.getRealBloomLayer());
    ...
    private void damageEntitiesAndBreakSnow() {
        ...
        if (getOffsetTimer() % 10 == 0) {
            ...
            Util.tryBreakSnowLayer(getWorld(), middlePos, state, true);
        }
    }
