...
public class MetaTileEntitySteamOven extends RecipeTypeSteamMultiblockController {
    ...
    public MetaTileEntitySteamOven(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, RecipeTypes.FURNACE_RECIPES, CONVERSION_RATE);
    ...
    public BlockState getFireboxState() {
        return ConfigHolder.machines.steelSteamMultiblocks ?
