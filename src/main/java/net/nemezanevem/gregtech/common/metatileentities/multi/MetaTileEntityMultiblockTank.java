...
public class MetaTileEntityMultiblockTank extends MultiblockWithDisplayBase {
    ...
    @Override
    protected ModularUI.Builder createUITemplate(@Nonnull Player entityPlayer) {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<Component> tooltip, boolean advanced) {
        ...
        tooltip.add(Component.translatable("gregtech.multiblock.tank.tooltip"));
        tooltip.add(Component.translatable("gregtech.universal.tooltip.fluid_storage_capacity", capacity));
    }
}
