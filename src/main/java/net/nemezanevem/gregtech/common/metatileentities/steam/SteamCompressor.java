...
public class SteamCompressor extends SteamMetaTileEntity {
    ...
    public SteamCompressor(ResourceLocation metaTileEntityId, boolean isHighPressure) {
        super(metaTileEntityId, RecipeTypes.COMPRESSOR_RECIPES, Textures.COMPRESSOR_OVERLAY, isHighPressure);
    }
    ...
    public ModularUI createUI(Player player) {
        return createUITemplate(player)
                ...
                .progressBar(workableHandler::getProgressPercent, 78, 25, 20, 18,
                        GuiTextures.PROGRESS_BAR_COMPRESS_STEAM.get(isHighPressure), MoveType.HORIZONTAL, workableHandler.getRecipeType())
