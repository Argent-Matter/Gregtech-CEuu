...
public class SteamHammer extends SteamMetaTileEntity {
    ...
    public SteamHammer(ResourceLocation metaTileEntityId, boolean isHighPressure) {
        super(metaTileEntityId, RecipeTypes.FORGE_HAMMER_RECIPES, Textures.FORGE_HAMMER_OVERLAY, isHighPressure);
    }
    ...
    public ModularUI createUI(Player player) {
        return createUITemplate(player)
                ...
                .progressBar(workableHandler::getProgressPercent, 79, 25, 20, 18,
                        GuiTextures.PROGRESS_BAR_HAMMER_STEAM.get(isHighPressure), MoveType.VERTICAL_DOWNWARDS, workableHandler.getRecipeType())
