...
public class MetaTileEntityFluidHatch extends MetaTileEntityMultiblockNotifiablePart implements IMultiblockAbilityPart<IFluidTank>, IControllable {
    ...
    public void readFromNBT(CompoundTag data) {
        ...
        if (data.contains("workingEnabled")) {
    ...
    public ModularUI.Builder createTankUI(IFluidTank fluidTank, String title, Player entityPlayer) {
    ...
    public void addInformation(ItemStack stack, @Nullable Level player, List<Component> tooltip, boolean advanced) {
        if (this.isExportHatch)
            ...
            tooltip.add(Component.translatable("gregtech.machine.fluid_hatch.import.tooltip"));
        tooltip.add(Component.translatable("gregtech.universal.tooltip.fluid_storage_capacity", getInventorySize()));
