...
public class MetaTileEntityMachineHatch extends MetaTileEntityMultiblockNotifiablePart implements IMultiblockAbilityPart<IItemHandlerModifiable> {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<Component> tooltip, boolean advanced) {
        ...
        tooltip.add(Component.translatable("gregtech.machine.machine_hatch.processing_array"));
    }
    ...
    private class LimitedImportHandler extends NotifiableItemStackHandler {
        ...
        public boolean isItemValid(int slot, @Nonnull ItemStack stack) {
            ...
            if (controller instanceof IMachineHatchMultiblock)
                return slotMatches && Util.isMachineValidForMachineHatch(stack, ((IMachineHatchMultiblock) controller).getBlacklist());
        ...
        public ItemStack extractItem(int slot, int amount, boolean simulate) {
            ...
            if (getController() instanceof RecipeTypeMultiblockController) {

                RecipeTypeMultiblockController controller = (RecipeTypeMultiblockController) getController();
