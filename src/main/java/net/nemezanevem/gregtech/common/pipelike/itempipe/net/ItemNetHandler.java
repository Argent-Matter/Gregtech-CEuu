...
public class ItemNetHandler implements IItemHandler {
    ...
    public ItemNetHandler(ItemPipeNet net, TileEntityItemPipe pipe, Direction facing) {
        this.net = net;
        this.pipe = pipe;
        this.facing = facing;
    ...
    public CoverBehavior getCoverOnPipe(BlockPos pos, Direction handlerFacing) {
        BlockEntity tile = pipe.getWorld().getBlockEntity(pos);
    ...
    public CoverBehavior getCoverOnNeighbour(BlockPos pos, Direction handlerFacing) {
        BlockEntity tile = pipe.getWorld().getBlockEntity(pos.offset(handlerFacing));
        if (tile != null) {
