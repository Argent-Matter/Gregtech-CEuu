...
public class BlockStoneSmooth extends VariantBlock<BlockStoneSmooth.BlockType> {
    ...
    @Override
    public boolean canCreatureSpawn(@Nonnull BlockState state, @Nonnull BlockGetter world, @Nonnull BlockPos pos, @Nonnull EntityLiving.SpawnPlacementType type) {
        return false;
    }

    public BlockStoneSmooth.BlockType getVariant(BlockState blockState) {
